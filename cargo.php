		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-9">
					...
					<h2>Cargo transportation (Land)</h2>

					<p>
						We at Inland Logistics Handlers take good care and faster with Road transportation of goods from one place to the other on roads.
						Sometimes road transport is the only way for carrying goods or cargo from rural areas which are not catered to by railway, water or air transport and we are here to deliver and relabel to our clients satisfying on time.
					</p>
					...
					<div class="background-main-color margin-bottom-40px">
						<div class="services-list">
							<ul>
								...
								<li class="active"><a href="cargo.php">Cargo Transportation </a></li>
							</ul>
						</div>
					</div>
