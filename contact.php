...
<head>
    <title>Inland Logistics Handlers | Contact Us</title>
...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 sm-mb-45px">
                    ...
                    <span class="d-block sm-mb-30px"><i class="fa fa-map text-main-color margin-right-10px" aria-hidden="true"></i>Three Canal Plaza, Ground Floor Portland, ME 04101</span>
                    <h5 class="margin-top-20px">Email :</h5>
                    <span class="d-block sm-mb-30px"><i class="fa fa-envelope-open text-main-color margin-right-10px" aria-hidden="true"></i>info@inlandlogisticshandlers.com</span>
                </div>
                <div class="col-lg-6">
    ...
    <div class="map-layout">
        <div class="map-embed">
            ...
            <iframe src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q=Three%20Canal%20Plaza,%20Ground%20Floor%20Portland,%20ME%2004101+(Inland%20Logistics%20Handlers)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed" width="100%" height="390" frameborder="0" style="border:0" allowfullscreen></iframe></>
        </div>
        <div class="container">
            <div class="row">
